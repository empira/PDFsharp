...
* It is easier to use code required by the C# compiler to use language features not available in
  .NET Framework or .NET Standard 2.0
* We have no public visible internal stuff anymore. E.g. the class **NRT** was introduced to transform the
...
**We do not use GitVersion anymore**

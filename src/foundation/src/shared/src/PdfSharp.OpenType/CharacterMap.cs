...
namespace PdfSharp.Internal.OpenType
{
    ...
    /// </summary>
    internal sealed class CharacterMap : IDictionary<int, ushort> // RENAME CodePointMap
    {
        /// <summary> 
        ...
        {
            // Some fonts have cmap entries that point to glyphs outside the font.
        ...
        public bool Contains(KeyValuePair<int, ushort> item) => throw new NotSupportedException();

        public void CopyTo(KeyValuePair<int, ushort>[] array, int arrayIndex) => throw new NotImplementedException();

        public bool Remove(KeyValuePair<int, ushort> item) => throw new NotSupportedException();

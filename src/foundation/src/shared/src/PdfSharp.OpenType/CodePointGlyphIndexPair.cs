...
namespace PdfSharp.Internal.OpenType
{
    ...
    /// </summary>
    public struct GlyphIndexGlyphColorRecordPair(ushort glyphIndex, ColorTable.GlyphRecord? colorRecord)
    {
        /// <summary>
        /// The glyph index.
        /// </summary>
        ...
        /// </summary>
        public ColorTable.GlyphRecord? ColorRecord = colorRecord;
    }
}

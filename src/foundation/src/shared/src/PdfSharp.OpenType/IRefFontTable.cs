    ...
    sealed class IRefFontTable : OpenTypeFontTable
    {
        ...
        public override void PrepareForCompilation()
        {
            ...
            if (DirectoryEntry.Tag != TableTagNames.Head)
            {
                ...
                Buffer.BlockCopy(_irefDirectoryEntry.FontTable.FontData!.OTFontSource.Bytes, _irefDirectoryEntry.Offset, bytes, 0, DirectoryEntry.PaddedLength);
        ...
        {
            writer.Write(_irefDirectoryEntry.FontTable.FontData!.OTFontSource.Bytes, _irefDirectoryEntry.Offset, _irefDirectoryEntry.PaddedLength);
        }
    }
}

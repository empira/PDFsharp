    ...
    public class ColorsRgb : Snippet
    {
        ...
        public override void RenderSnippet(XGraphics gfx)
        {
            ...
            BeginBox(gfx, 2, BoxOptions.Tile);
            {
                ...
                {
                    var rect = GetDeciRect(idx);
                    gfx.DrawRectangle(new XSolidBrush(XColor.FromArgb(idx * 255 / 9, 255, 255, 0)), rect);
                }
            }
            EndBox(gfx);
            ...
            BeginBox(gfx, 3, BoxOptions.Tile);
            {
                ...
                {
                    var rect = GetDeciRect(idx);
                    gfx.DrawRectangle(new XSolidBrush(XColor.FromArgb(idx * 255 / 9, 0, 255, 255)), rect);
                }
            }
            EndBox(gfx);
            ...
            BeginBox(gfx, 4, BoxOptions.Tile);
            {
                ...
                {
                    var rect = GetDeciRect(idx);
                    gfx.DrawRectangle(new XSolidBrush(XColor.FromArgb(idx * 255 / 9, 0, 255, 0)), rect);
                }
            }
            EndBox(gfx);
            ...
            BeginBox(gfx, 5, BoxOptions.Tile);
            {
                ...
                {
                    var rect = GetDeciRect(idx);
                    gfx.DrawRectangle(new XSolidBrush(XColor.FromArgb(idx * 255 / 9, 255, 0, 255)), rect);
                }
            }
            EndBox(gfx);
            ...
            BeginBox(gfx, 6, BoxOptions.Tile);
            {
                ...
                {
                    var rect = GetDeciRect(idx);
                    gfx.DrawRectangle(new XSolidBrush(XColor.FromArgb(idx * 255 / 9, 255, 0, 0)), rect);
                }
            }
            EndBox(gfx);
            ...
            BeginBox(gfx, 7, BoxOptions.Tile);
            {
                ...
                {
                    var rect = GetDeciRect(idx);
                    gfx.DrawRectangle(new XSolidBrush(XColor.FromArgb(idx * 255 / 9, 0, 0, 255)), rect);
                }
            }
            EndBox(gfx);
            ...
            BeginBox(gfx, 8, BoxOptions.Tile);
            {
                ...
                {
                    var rect = GetDeciRect(idx);
                    gfx.DrawRectangle(new XSolidBrush(XColor.FromArgb(idx * 255 / 9, 0, 0, 0)), rect);
                }
            }
            EndBox(gfx);
        }

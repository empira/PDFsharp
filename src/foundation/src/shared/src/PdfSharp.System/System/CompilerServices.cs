...
// All classes are internal, i.e. using PDFsharp packages does not bring this functionality into
// your projects.
...
namespace System
{
    // This is the original source code from GitHub.,Therefore, no problems are expected.

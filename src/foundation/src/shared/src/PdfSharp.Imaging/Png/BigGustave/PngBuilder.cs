...
namespace PdfSharp.Internal.Imaging.Png.BigGustave
{
    using System;
    ...
    public class PngBuilder
    {
        ...
        /// Must not start with, end with, or contain consecutive white-space characters.
        ...
        public PngBuilder StoreText(string keyword, string text)
        {
            ...
            for (var i = 0; i < keyword.Length; i++)
            {
                ...
                // pngTODO: trailing, leading and consecutive white-space are also prohibited.
            }

...
namespace PdfSharp.Tests.Pdf.Signatures
{
    ...
    public class DefaultSignerTests : IDisposable
    {
        ...
        public void Sign_new_file_Default(string certType, PdfMessageDigestType digestType, string timestampURL)
        {
            ...
            // digitalSignatureHandler What to do with it? Set SHA-level? Set TimeStamp?
        ...
        public void Sign_new_file_Default_in_a_loop(string certType, PdfMessageDigestType digestType, string timestampURL)
        {
            ...
            for (int loop = 1; loop <= loops; loop++)
            {
                ...
                var digitalSignatureHandler = DigitalSignatureHandler.ForDocument(document,
        ...
        public void Sign_existing_file_Default()
        {
            ...
            var digitalSignatureHandler = DigitalSignatureHandler.ForDocument(document, new PdfSharpDefaultSigner(GetCertificate("test-cert_rsa_1024"), PdfMessageDigestType.SHA512), options);
        ...
        public void Sign_with_Certificate_from_Store()
        {
            ...
            var digitalSignatureHandler = DigitalSignatureHandler.ForDocument(document, new PdfSharpDefaultSigner(certificate, PdfMessageDigestType.SHA256), options);
        ...
        class SignatureAppearanceHandler : IAnnotationAppearanceHandler
        {
            public void DrawAppearance(XGraphics gfx, XRect rect)
            {
                ...
                string text = "John Doe\nSeattle, " + DateTimeOffset.Now.ToString(CultureInfo.GetCultureInfo("EN-US"));

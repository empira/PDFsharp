...
namespace PdfSharp.Pdf.Advanced
{
    ...
    {
        internal static readonly uint[] WhiteTerminatingCodes =
        [
            0x35, 8, //00110101 // 0
            0x07, 6, //000111
            0x07, 4, //0111
        ...
        internal static readonly uint[] BlackTerminatingCodes =
        [
        ...
        internal static readonly uint[] WhiteMakeUpCodes =
        [
            0x1b,  5, //11011 64          // 0
            0x12,  5, //10010 128
            0x17,  6, //010111 192
        ...
        internal static readonly uint[] HorizontalCodes = [0x1, 3]; /* 001 */
        internal static readonly uint[] PassCodes = [0x1, 4]; /* 0001 */
        internal static readonly uint[] VerticalCodes =
        [
            0x03, 7, /* 0000 011 */
            0x03, 6, /* 0000 11 */
            0x03, 3, /* 011 */
        ...
        static readonly uint[] _zeroRuns =
        [
        ...
        static void FaxEncode2DRow(BitWriter writer, uint bytesFileOffset, byte[] imageBits, uint currentRow, uint referenceRow, uint width, uint height, uint bytesPerLineBmp)
        {
            ...
            else
            {
                ...
                for (int idx = 0; idx < bytesPerLineBmp; idx++)
                    tmpImageBits[idx] = 255;

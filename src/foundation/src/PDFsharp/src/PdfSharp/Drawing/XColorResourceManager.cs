        ...
        internal static ColorResourceInfo[] colorInfos = new ColorResourceInfo[]
            {
              ...
              new ColorResourceInfo(XKnownColor.Fuchsia, XColors.Fuchsia, 0xFFFF00FF, "Fuchsia", "Fuchsie"), // Same as Magenta, but needed to avoid exception at ToColorName().
              ...
              new ColorResourceInfo(XKnownColor.Aqua, XColors.Aqua, 0xFF00FFFF, "Aqua", "Blaugrün"), // Same as Cyan, but needed to avoid exception at ToColorName().

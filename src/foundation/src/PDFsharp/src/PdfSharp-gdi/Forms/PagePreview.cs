...
namespace PdfSharp.Forms
{
    ...
    */
    ...
    public class PagePreview : UserControl
    {
        ...
        Action<XGraphics> _renderAction = null!;
        ...
        internal void CalculatePreviewDimension(out bool zoomChanged)
        {
            ...
            switch (_zoom)
            {
                ...
                case Zoom.TextFit:
                    // TODO_OLD: 'public Rectangle TextBox' property
                    goto BestFit;
        ...
        internal bool RenderPage(Graphics gfx)
        {
            ...
            if (_renderAction != null!)
            {
                ...
                XGraphics xgfx = XGraphics.FromGraphics(gfx, new XSize(_pageSize.Width, _pageSize.Height), PageGraphicsUnit, null!);
                try
                {
                    _renderAction(xgfx);
                }

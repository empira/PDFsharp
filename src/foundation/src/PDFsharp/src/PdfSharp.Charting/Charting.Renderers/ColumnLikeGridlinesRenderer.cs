...
namespace PdfSharp.Charting.Renderers
{
    ...
    /// </summary>
    class ColumnLikeGridlinesRenderer : GridlinesRenderer
    {
        /// <summary>
        /// Initializes a new instance of the ColumnLikeGridlinesRenderer class with the
        /// specified renderer parameters.
        /// </summary>
        internal ColumnLikeGridlinesRenderer(RendererParameters parms) : base(parms)
        { }
        ...
        internal override void Draw()
        {
            ...
            if (yari.MinorGridlinesLineFormat != null)
            {
                ...
                {
                    points[0].X = (float_)xMin;
                    points[0].Y = (float_)y;
                    points[1].X = (float_)xMax;
                    points[1].Y = (float_)y;
                    matrix.TransformPoints(points);
                    lineFormatRenderer.DrawLine(points[0], points[1]);
                }

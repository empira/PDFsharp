...
namespace PdfSharp.TestHelper.Analysis.ContentStream
{
    ...
    /// </summary>
    public abstract class ObjectGetterBase<T>(ContentStreamEnumerator contentStreamEnumerator)
    {
        /// <summary>
        ...
        {
            return ContentStreamEnumerator.MoveAndGet(IdentifyingElementCheck, steps, countThisTypeOnly, backwards, GetObject, out obj);
        }
        ...
        {
            var cachedState = ContentStreamEnumerator.GetState();
            ...
            else
            {
                ...
                if (stepsBefore <= 0 || ContentStreamEnumerator.Move(_ => true, steps, false, backwards))
                {
            ...
            ContentStreamEnumerator.SetState(cachedState);
            return false;
        }
